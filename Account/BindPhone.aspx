<%@ page title="" language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Account_BindPhone, App_Web_bindphone.aspx.dae9cef9" %>
                ...
                <div>
                    <ol style="list-style:none;margin-left:30px;">
                        <li>
                            ...
                            <asp:RegularExpressionValidator ValidationExpression="^[1][358]\d{9}$" ID="RegularExpressionValidator3" runat="server" ControlToValidate="PhoneNumber"
