<%@ page title="" language="C#" masterpagefile="~/CommonInterface/CommonInterface.master" autoeventwireup="true" inherits="CommonInterface_ItemEdit, App_Web_rzv2xkl2" %>
    ...
    <div id="manage_body_wrapper">
        <div id="manage_publish_wrapper">
            <fieldset class="any_item_wrapper manage_wrapper">
                ...
                <asp:RegularExpressionValidator runat="server" ValidationExpression="^(\d+.?)?\d+$"  ControlToValidate="ListPrice" EnableClientScript="true" Display="Dynamic" ErrorMessage="原价必须是数字或者'.'" /><br /><br />
                ...
                <asp:RegularExpressionValidator runat="server" ValidationExpression="^(\d+.?)?\d+$"  ControlToValidate="UnitPrice" EnableClientScript="true" Display="Dynamic" ErrorMessage="现价必须是数字或者'.'" /><br /><br />
                ...
                <asp:Label ID="Label10" runat="server" Text="排序：" />
                <asp:TextBox runat="server" ID="SEQUNENE" />
                <asp:RegularExpressionValidator ID="RegularExpressionValidator1" runat="server" ValidationExpression="^-?[0-9]\d*$" ControlToValidate="SEQUNENE" EnableClientScript="true" Display="Dynamic" ErrorMessage="必须是整数" /><br />
                <asp:Label ID="Label9" runat="server" Text="是否是推荐商品：" />
                ...
                <asp:Image runat="server" ID="ItemImage" Width="550" /><br />
                <asp:Label ID="Label8" runat="server" Text="物品详情：" /><br />
                <asp:TextBox ID="DescTextBox" runat="server" TextMode="MultiLine" style="min-width:785px;max-width:785px;min-height:200px;max-height:550px;" />
                <br />
