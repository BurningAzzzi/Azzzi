<%@ page title="中介列表 - " language="C#" masterpagefile="~/Site.master" autoeventwireup="true" inherits="Mediums, App_Web_oi3sipj0" %>
        ...
        <asp:Repeater runat="server" ID="HotelsRepeater" OnItemDataBound="HotelsRepeater_ItemDataBound">
            ...
            <ItemTemplate>
                <section class="any_item_wrapper">
                    <div class="list_top">
					    <a id="A1" target="_blank" runat="server" limit="12" href='<%# String.Format("~/Medium.aspx?id={0}",Eval("ShopId")) %>' class="shop_name">
						    <%# Eval("Name") %>
					    </a>
